...
function Home() {
  return (
    <div>
      <div className="w-screen my-8 container bg-gradient-to-r from-black to-blue-300 mx-auto px-6 bg-opacity-50 flex items-center  rounded-lg overflow-hidden bg-cover bg-center  ">
        <div className="px-10 max-w-xl">
          ...
          <div className="mt-6 py-2">
            <a
              href="/resume.pdf"
              className="inline-block text-xl px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-blue-300 hover:bg-white "
        ...
        <div className="lg:ml-32 relative py-4 px-4 ">
          ...
          <img
            className=" border-transparent hover:border-2 rounded-full  relative w-60 "
      ...
      <Canvas camera={{ pov: 75, position: [0, 0, 10] }}>
        <Animation />
      </Canvas>
    </div>
  );
